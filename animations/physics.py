...
def _limit(value: int | float, min_value: int | float, max_value: int | float) -> int | float:
...
def _apply_acceleration(speed: int | float, speed_limit: int | float, forward: bool = True) -> int | float:
...
def update_speed(
    ...
    rows_direction: int | float,
    columns_direction: int | float,
