...
from animations import animate_spaceship, blink, fill_orbit_with_garbage, fire
...
def main(canvas: Any) -> None:
    ...
    coroutines.append(fill_orbit_with_garbage(canvas, get_frames("animations/garbage"), coroutines))
